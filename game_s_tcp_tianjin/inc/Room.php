...
class ContendBanker
{
	public $is_received;                // 是否收到客户端消息
	public $is_contend_banker;          // 拉庄选择,不拉或者拉庄

	public function clear()
	{
		$this->is_received = 0;
		$this->is_contend_banker = array();
	}
...
class RuleTianJin
{
    ...
    public $is_circle;           // 按圈打
	public $pay_type;            // 付费方式
	public $is_chipai;           // 是否可吃牌
	public $cancle_clocker;      // 倒计时小闹钟
	public $is_feng;             // 是否带风牌
	public $is_contend_banker;   //拉庄           
	public $is_kou_ting;         //扣听           
	public $is_fanhun;         	 //翻混          
