...
class GameShijiazhuang
{
	...
	const HU_TYPE_PENGPENGHU = 30;           // 飘胡....
	...
	//const ATTACHED_HU_ZHUANG = 71;            // 庄家
	const ATTACHED_HU_ZIYISE = 72;            // 字一色

	//－－－－－－－－－－－－－杠分 －－－－－－－－－－－－－－－－－－－
	const M_ZHIGANG_SCORE = 3;                 // 直杠
	const M_ANGANG_SCORE = 2;                  // 暗杠
	const M_WANGANG_SCORE = 3;                 // 弯杠 点碰的人给

	public static $hu_type_arr = array(
	self::HU_TYPE_PINGHU=>[self::HU_TYPE_PINGHU, 1, '平胡']  //平胡  不就倍分 算底分  作为低分2分
	,self::HU_TYPE_PENGPENGHU=>[self::HU_TYPE_PENGPENGHU, 4, '飘胡']
	...
	public function c_open_room($fd, $params)
	{
		...
		do {
			...
			$this->clear();
			$this->m_rule = new RuleShijiazhuang();
			...
			$params['rule']['is_da8zhang'] = !isset($params['rule']['is_da8zhang']) ? 0 : $params['rule']['is_da8zhang'];
			$params['rule']['is_paozi'] = !isset($params['rule']['is_paozi']) ? 0 : $params['rule']['is_paozi'];
			$params['rule']['is_quemen'] = !isset($params['rule']['is_quemen']) ? 1 : $params['rule']['is_quemen'];
			...
			$params['rule']['is_ganghua_fan'] = !isset($params['rule']['is_ganghua_fan']) ? 0 : $params['rule']['is_ganghua_fan'];
