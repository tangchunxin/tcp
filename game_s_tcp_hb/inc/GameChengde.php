...
class GameChengde
{
	...
	,self::HU_TYPE_SHISANYAO=>[self::HU_TYPE_SHISANYAO, 5, '十三幺']
	...
	,self::ATTACHED_HU_QINGYISE=>[self::ATTACHED_HU_QINGYISE, 1, '清一色']
	,self::ATTACHED_HU_YITIAOLONG=>[self::ATTACHED_HU_YITIAOLONG, 1, '一条龙']
	,self::ATTACHED_HU_HAIDI=>[self::ATTACHED_HU_HAIDI, 1, '海底捞月']
