...
m_rule	游戏规则
	...
	is_tiandi_hu_fan //天地胡加番  0 否 1 是


m_sysPhase	当前阶段状态
    SYSTEMPHASE_XIA_PAO = 9; // 下炮阶段 
...
m_HuCurt		胡牌详情
{
	...
	HU_TYPE_QIDUI = 22; //七对
	HU_TYPE_HAOHUA_QIDUI = 23; //豪华七对....
	HU_TYPE_CHAOJIHAOHUA_QIDUI = 24; //超级豪华七对....
	HU_TYPE_FENGDING_TYPE_INVALID  = 0; //错误

	//－－－－－－－－－－－－－附加番 －－－－－－－－－－－－－－－－－－－
	ATTACHED_HU_TIANHU = 61; //天胡 
	ATTACHED_HU_ZIMOFAN = 62; //自摸   默认
	ATTACHED_HU_GANGKAI = 63; //杠开
	ATTACHED_HU_QIANGGANG = 64; //抢杠

	ATTACHED_HU_YITIAOLONG = 65; //一条龙
