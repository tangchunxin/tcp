...
use gf\inc\Game_cmd;
class GameGaoyang extends BaseGame
{
    const GAME_TYPE = 127;
    //－－－－－－－－－－－－－胡牌类型 －－－－－－－－－－－－－－－－－－－
    ...
    public static $attached_hu_arr = array(
		...
		,self::ATTACHED_HU_HAIDI=>array(self::ATTACHED_HU_HAIDI, 2, '海底捞月')	
    );
	...
	{
		$lose_chair = $this->m_sOutedCard->chair;
		...
		// 		continue;
		// 	}
			$nGangScore = 3 * self::M_ZHIGANG_SCORE * ConstConfig::SCORE_BASE;
			$this->m_wGangScore[$lose_chair][$lose_chair] -= $nGangScore;
			$this->m_wGangScore[$chair][$chair] += $nGangScore;
			$this->m_wGangScore[$chair][$lose_chair] += $nGangScore;
